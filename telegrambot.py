...
async def generate_chart_image_and_send_to_telegram(layout_id, api_key, symbol, interval):
...
await generate_chart_image_and_send_to_telegram(LAYOUT_ID, API_KEY, SYMBOL, INTERVAL)
